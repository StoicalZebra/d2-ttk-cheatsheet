...
| Weapon | Frame (RPM)         | WPN | Base TTK | New TTK | Base STK | New STK | Perks                | Source     | Notes |
|--------|------------         |-----|----------|---------|----------|-------  |------                | ------     | ----- |
| Pulse  | Adaptive (390)      | ??? | 1.00     | ????    | 6h2b     | 7h      | None                 | Hugo + Era | Don't know how to interpret entries for Adaptive Pulse TTK shifts; Hugo shows only 112 WPN needed for TTk shift but building all the way up to 168 WPN for just ease-of-use? |
| Pulse  | Lightweight (450)   | 186 | 0.87     | ????    | 7h1b     | 7h      | None                 | Hugo       | Don't know new TTK math | 
...
| Weapon  | Frame (RPM)           | WPN | TTK  | Base STK | New STK | Perks                     | Source | Notes |
|---------|---------------------  |-----|------|----------|---------|--------------             |------- | ------|
| Pulse   | Adaptive (390)        | 168 | 1.00 | 6h2b     | 5h3b    | None                      | Hugo   |       |
| Pulse   | Agressive Burst (450) | 106 | 0.73 | 8h       | 7h1b    | None                      | Hugo   |       |
